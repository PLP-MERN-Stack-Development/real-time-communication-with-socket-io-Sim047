...
// expose io and onlineUsers map via app so route handlers can use them
app.set("io", io);
...
// static uploads dir (ensure UPLOAD_DIR env var points to folder)
...
<<<<<<< HEAD
  ...
  // DELIVERY / READ HANDLING (same as before)
